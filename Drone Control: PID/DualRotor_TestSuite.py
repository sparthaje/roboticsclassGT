...
# Visualization flags
#
# SHOW_VISUALIZATION - Enable/disable real-time TKinter visualization window
#                           Set to False for faster Twiddle iterations
# SHOW_PLOTS             - Enable/disable Matplotlib plots shown after execution
...
VISUALIZE = SHOW_VISUALIZATION or SHOW_PLOTS
...
class Part_1_a_TestCase(unittest.TestCase):
    ...
    def run_test(self, plan, target_y_error=0.02, target_x_error=0.02, tune="both", score_weight=1, test_integral=False, drone_rpm_error = 0, test_roll=True):
        ...
        #thrust_params       = {'tau_p': 1, 'tau_d': 31, 'tau_i': 0} 
        #roll_params         = {'tau_p': 0.16, 'tau_d': 9.6, 'tau_i': 0}
        thrust_params       = {'tau_p': 5, 'tau_d': 0, 'tau_i': 0} 
        roll_params         = {'tau_p': 0.16, 'tau_d': 9.6, 'tau_i': 0}
