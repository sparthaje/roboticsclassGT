...
from settings import test_settings, JUMP_SCORE_BONUS
...
def run_method(method_name):
    """
    :param method_name (string): Parameter to run either 'estimate' or 'jump'.
    :return:
    """
...
class MultiCaseGrader():
    ...
    def run(self):
        ...
        score_jump = min(score_jump, (num_jump_cases - JUMP_SCORE_BONUS)) # JUMP_SCORE_BONUS currently provides grace points for jump section
        max_jump_score = int(max_jump_score - JUMP_SCORE_BONUS)
